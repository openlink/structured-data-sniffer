...
#copy common files
for I_DIR in frame.js handlers.js converters.js ttl_gen.js html_gen.js options.js panel.js settings.js sniffer.css sniffer.js page_panel.js psniffer.css content.css; do
  cp -va $SRC_DIR/$I_DIR $DST_DIR/
done
